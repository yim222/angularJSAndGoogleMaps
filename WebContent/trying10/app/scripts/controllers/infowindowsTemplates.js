...
function toManuallyAddedInfoTemplate(targetPlace, targetDetails ){
	...
	var details =  "<div><img src='"+ targetDetails.imgUrl + "' width='42' height='42'>"
	 +"<h2>Target name - " + targetDetails.name + "</h2>"
	...
	+"<p>note : " + targetPlace.note+ "</p>"
	+'<p id="infowindow_content"  ng-click="test(game)">sddsfsgrdrge</p>'
	+"</div>";
